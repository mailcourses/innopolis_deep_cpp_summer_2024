...
Написать свою реализацию АВЛ-дерева с интерфейсом std::map, аллокатор и двунаправленного итератора для него.
...
- begin, rbegin
- end, rend
- конструктор, принимающий std::initializer\_list
